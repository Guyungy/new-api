...
import RequestInterceptionModal from './modals/RequestInterceptionModal';
...
const UsersTable = (usersData) => {
  ...
  const [showUserSubscriptionsModal, setShowUserSubscriptionsModal] =
    useState(false);
  const [showRequestInterceptionModal, setShowRequestInterceptionModal] =
    useState(false);
  ...
  const showRequestInterceptionUserModal = (user) => {
    setModalUser(user);
    setShowRequestInterceptionModal(true);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showRequestInterceptionModal: showRequestInterceptionUserModal,
    });
  }, [
    t,
    setEditingUser,
    ...
    showRequestInterceptionUserModal,
  ]);
  ...
  return (
    <>
      ...
      <RequestInterceptionModal
        visible={showRequestInterceptionModal}
        onCancel={() => setShowRequestInterceptionModal(false)}
        user={modalUser}
        onSuccess={() => refresh?.()}
        t={t}
      />
