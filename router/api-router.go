	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/request_interception", controller.GetUserRequestInterception)
				adminRoute.POST("/", controller.CreateUser)
				adminRoute.POST("/manage", controller.ManageUser)
				adminRoute.PUT("/:id/request_interception", controller.UpdateUserRequestInterception)
		...
		logRoute.GET("/intercept_stat", middleware.AdminAuth(), controller.GetRequestInterceptionStat)
		logRoute.GET("/user_ranking", middleware.AdminAuth(), controller.GetUserUsageRanking)
